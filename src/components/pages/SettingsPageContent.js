    ...
    return (
        <div className="w-full max-w-xl mx-auto">
            <div className="bg-white rounded-[32px] p-6 md:p-10 shadow-sm border border-gray-100 flex flex-col items-center gap-8 transition-all hover:shadow-md">
                ...
                <div className="w-full flex flex-col gap-6">
                    ...
                    <div className="pt-2">
                         <button
                            ...
                            className="w-full h-[56px] bg-[#BCC3E7] text-white font-black text-xs uppercase tracking-widest rounded-xl shadow-lg shadow-[#1E2761]/10 hover:bg-[#1E2761] hover:shadow-xl hover:shadow-[#1E2761]/20 hover:-translate-y-0.5 hover:scale-[1.01] transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:translate-y-0 disabled:hover:bg-[#BCC3E7]"
                        >
                            {saving ? (
             ...
             {message && (
                <div className={`mt-6 p-4 rounded-2xl text-center text-sm font-bold flex items-center justify-center gap-3 shadow-sm border ${
