...
export default function SignIn() {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center bg-[var(--bg-color)] px-6 py-12 relative overflow-hidden transition-colors duration-300">
      {/* Decorative elements with glow and float */}
      ...
      <div className="w-full max-w-md p-0 bg-[var(--bg-color)] rounded-[2.5rem] shadow-2xl border border-cool-gray/50 overflow-hidden relative z-10 transition-all duration-500 hover:scale-[1.02] hover:shadow-primary/20 group">
        <div className="bg-primary p-12 text-center relative overflow-hidden">
            ...
            <div className="w-20 h-20 bg-white/20 rounded-[1.5rem] flex items-center justify-center mx-auto mb-6 backdrop-blur-md border border-white/30 group-hover:rotate-12 transition-transform duration-500">
